...
function LinkCard({ link, onReclaim }: { link: LinkData; onReclaim: (seed: string | number[]) => Promise<void> }) {
    ...
    <div className="container" style={{ maxWidth: '720px', paddingTop: '40px' }}>
      <div className="flex items-center justify-between" style={{ marginBottom: '24px' }}>
        ...
        <div className="flex gap-sm">
          ...
          <Link href="/create" className="btn btn-primary btn-sm">+ Create New</Link>
        </div>
      </div>
